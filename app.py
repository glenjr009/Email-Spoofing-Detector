...
<div class="container py-5">
        ...
        <div class="col-lg-5">
            <div class="cyber-card h-100 text-center d-flex flex-column justify-content-center">
                ...
                <p class="text-secondary small mb-4">
                    Ingesting data from directory: <code>/TEST_SAMPLES</code>
                </p>
            ...
            <div class="cyber-card p-3">
                ...
                <div class="metric-pill">
                    ...
                    <span class="metric-value">
                        {{ (metrics.count / metrics.time)|round(2) if metrics.time > 0 else 0 }} msg/sec
                    </span>
                </div>
            </div>
        </div>
    ...
    <div class="cyber-card">
        ...
        <div class="table-responsive">
            <table class="table table-dark table-hover align-middle">
                ...
                <tr class="{% if r.score >= 40 %}threat-row{% else %}safe-row{% endif %}">
                    ...
                    <td>
                        {% if r.score >= 40 %}
                            <span class="text-danger fw-bold">!! THREAT</span>
                        {% else %}
        ...
        <a href="/download_csv" class="btn btn-outline-info w-100 mt-4 font-orbitron small">
            DOWNLOAD_FORENSIC_REPORT.CSV
        </a>
    </div>
            ...
            data: {
                ...
                datasets: [{
                    data: [
                        ...
                        results.length - results.filter(r => r.score >= 40).length
                    ],
                    backgroundColor: ['#ff3131', '#00ff41'],
                    borderWidth: 0
                }]
            },
            options: {
